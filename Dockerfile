...
RUN pip install --no-cache-dir ptvsd==4.3.2 debugpy~=1.6.7 pydevd-pycharm~=231.9225.15 torch tensorboard git+https://github.com/pytorch/tensordict git+https://github.com/pytorch/rl
